...
#creating copy of the 1 word frequency table to find hard skills
techskill = c("Python", "python", "R", "SQL", "sql", "Sql", "Spark", "spark", "Hadoop", "hadoop","java", "Java", "tableau", "Tableau", "AWS", "aws", "Aws", "SAS", "sas", "Hive", "hive", "TensorFlow", "Tensorflow", "tensorflow", "Scala", "scala", "C++", "c++", "Excel", "excel", "Azure", "azure")
res1 <- res %>% 
  select(-3) %>% 
...
#typeof(df$col)
#head(res2 %>% arrange(desc(freq)),40)
