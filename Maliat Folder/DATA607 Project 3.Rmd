...
#creating copy of the 1 word frequency table to find hard / technical skills
techskill = c("Python", "python", "R", "SQL", "sql", "Sql", "Spark", "spark", "Hadoop", "hadoop","java", "Java", "tableau", "Tableau", "AWS", "aws", "Aws", "SAS", "sas", "Hive", "hive", "TensorFlow", "Tensorflow", "tensorflow", "Scala", "scala", "C++", "c++", "Excel", "excel", "Azure", "azure", "Mathematics", "mathematics", "Statistics", "statistitcs", "programming", "Programming", "debugging", "Debugging", "Probability", "probability", "modeling", "Modeling", "Matplotlib", "matplotlib", "OpenRefine", "Openrefine", "openrefine")
res1 <- res %>% 
  select(-3) %>% 
  filter(w1 %in% techskill)
#recreating two term freq count hard skill/ technical
hardskill= c("Machine learning", "machine learning", "data visualization", "Data visualization", "Quantitative analysis", "quantitative analysis", "Data analysis", "data analysis")
res2 <- createNgram(text,2)
res2 <- res2 %>% 
  select(-3) %>% 
  filter(w1w2 %in% hardskill)
#view(res2)
softskill = c("Communication", "communication", "collaboration", "Collaboration", "preceptiveness", "Perceptiveness", "Preseptive", "perseptive", "Judgement", "judgement", "teamwork", "Teamwork")
res3 <- createNgram(text,1)
res3 <- res3 %>% 
  select(-3) %>% 
  filter(w1 %in% softskill)
softskill2 = c("Critical Thinking", "Critical thinking", "critical thinking", "creative thinking", "Creative Thinking", "Creative thinking", "Problem Solving", "problem solving", "Problem solving", "interpersonal skills", "Interpersonal Skills", "Interpersonal skills", "generating hypothesis", "Generating Hypothesis", "Generating hypothesis", "Active listening", "Active Listening", "active listening", "active learning", "Active learning", "Active Learning")
res4 <- createNgram(text,2)
res4 <- res4 %>% 
  select(-3) %>% 
