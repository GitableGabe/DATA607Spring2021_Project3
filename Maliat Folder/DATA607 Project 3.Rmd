...
##### HARD and TECH Skills, both 1 word and 2 word hard and tech skills are together
####should we split up hard skills VS tech skills?
...
techskill = c("Python", "python", "R", "r", "SQL", "sql", "Sql", "Spark", "spark", "Hadoop", "hadoop","java", "Java", "tableau", "Tableau", "AWS", "aws", "Aws", "SAS", "sas","Sas", "Hive", "hive", "TensorFlow", "Tensorflow", "tensorflow", "Scala", "scala", "C++", "c++", "Excel", "excel", "Azure", "azure", "Mathematics", "mathematics", "Statistics", "statistitcs", "programming", "Programming", "debugging", "Debugging", "Probability", "probability", "modeling", "Modeling", "Matplotlib", "matplotlib", "OpenRefine", "Openrefine", "openrefine", "python", "r", "sql", "hadoop", "spark", "tableau", "statistics", "sas", "matlab", "bigml", "d3.js", "excel", "ggplot2","jupyter","nltk","scikit-learn","tensorflow","weka","matplotlib","predictive","ai","mathematics","c", "hive","aws","linux","nosql","azure","basic","bayesian","mapreduce")
...
hardskill= c("Machine learning", "machine learning", "data visualization", "Data visualization", "Quantitative analysis", "quantitative analysis", "Data analysis", "data analysis", "artificial intelligence", "Artificial intelligence", "Artificial Intelligence", "predictive analysis")
...
softskill = c("Communication", "communication", "collaboration", "Collaboration", "preceptiveness", "Perceptiveness", "Preseptive", "perseptive", "Judgement", "judgement", "teamwork", "Teamwork", "collaborate", "Collaborate", "professional", "veteran", "lead", "leadership", "leader", "innovation", "innovate", "innovative", "collaborative", "passionate", "creative", "motivated", "integrity", "effectiveness", "pioneering","communication", "collaboration", "preceptiveness", "perseptive","teamwork","collaborate")
...
softskill2 = c("Critical Thinking", "Critical thinking", "critical thinking", "creative thinking", "Creative Thinking", "Creative thinking", "Problem Solving", "problem solving", "Problem solving", "interpersonal skills", "Interpersonal Skills", "Interpersonal skills", "generating hypothesis", "Generating Hypothesis", "Generating hypothesis", "Generate hypothesis", "Generate Hypothesis", "generate hypothesis", "Active listening", "Active Listening", "active listening", "active learning", "Active learning", "Active Learning")
...
```{r}
#unnecessary_words = c("and","to","the","with","of","or","The","from","our")
#gsub(paste0(unnecessary_words,collapse = "|"),"", res$w1)
#res$w1 <- gsub(paste0(unnecessary_words,collapse = "|"),"",res$w1)
```
...
```{r}
randomForest(formula = `Hard and Tech Skills` ~ ., data = trainSparse ,ntree=100,mtry=2, importance = TRUE) 
```

```{r}
#train the model using naive bayes

sms_classifier <- naiveBayes(trainSparse,trainSparse$`Hard and Tech Skills` )
sms_pred <- predict(sms_classifier,testSparse )
```
...
CrossTable(sms_pred, testSparse$`Hard and Tech Skills`, prop.chisq = FALSE, chisq = FALSE, 
           prop.t = FALSE,
...
##treemap
 ...
 treemap(totaltech,index =c("python","statistics","sql","modeling","programming","spark","mathematics","ai","predictive","Hadoop","datanalysis","java","c","hive","datavisualization","tableau","sas","scala","azure","basicexcel","linux","artificialintelligence","aws","matlab,nosql","tensorflow","mapreduce","quantitative analysis","bayesian probability","jupyter","nltk","debugging","predictive analysis","matplotlib","weka"
),vSize = "freq")
```
